<?php
/**
 * LimitResults action for Search module
 *
 * PHP version 5
 *
...
/**
 * This action only exists to allow limiting behavior to work when Javascript is
 * disabled.  Normally, Javascript reads the new limit URL and redirects accordingly.
 * If Javascript is unavailable, the user has to submit the limit URL to this page,
