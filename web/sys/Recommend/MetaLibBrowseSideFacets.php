 ...
 * @link     http://vufind.org/wiki/building_a_recommendations_module Wiki
 */
class MetaLibBrowseSideFacets extends SideFacets
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct($searchObject, 'MetaLibBrowse');
    }
    ...
    public function process()
    {
        ...
        $interface->assign('searchObject', 'SolrMetaLibBrowse');
        parent::process();

        $interface->assign('activeFacets', array_keys($this->_mainFacets));
        $interface->assign('sideFacetLabel', 'Narrow Databases');
    }
}
