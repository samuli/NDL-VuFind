...
<div class="span-13">
  ...
  <table cellpadding="2" cellspacing="0" border="0" class="citation" summary="{translate text='Bibliographic Details'}">
    ...
    {/if}
      ...
      {if !empty($coreDateDescription)}
      <tr valign="top">
        <th>{translate text='Date'}: </th>
        <td>
          {foreach from=$coreDateDescription item=field name=loop}
            {$field|escape}<br>
          {/foreach}
       </td>
      </tr>
      ...
      {if !empty($coreBiographicalHistory)}
      <tr valign="top">
        <th>{translate text='Biographical History'}: </th>
        <td>{$coreDateDescription|escape}</td>
      </tr>
      {/if}
      ...
      <tr valign="top">
        ...
        <td>
          {foreach from=$coreAccess item=field name=loop}
            {$field|escape}<br>
          {/foreach}
        </td>
      </tr>
      ...
      {if !empty($coreRelated)}
      <tr valign="top">
        <th>{translate text='Related Material'}: </th>
        <td>
          {foreach from=$coreRelated item=field name=loop}
            {$field|escape}<br>
          {/foreach}
        </td>
      </tr>
      ...
      {if !empty($corePublicationNotes)}
      <tr valign="top">
        <th>{translate text='Publication Notes'}: </th>
        <td>
          {foreach from=$corePublicationNotes item=field name=loop}
            {$field|escape}<br>
          {/foreach}
        </td>
      </tr>
      ...
      {if !empty($coreActionNotes)}
      <tr valign="top">
        <th>{translate text='Action Notes'}: </th>
        <td>
          {foreach from=$coreActionNotes item=field name=loop}
            {$field|escape}<br>
          {/foreach}
        </td>
      </tr>
      ...
      {if !empty($coreCopiesNotes)}
      <tr valign="top">
        <th>{translate text='Copy Notes'}: </th>
        <td>
          {foreach from=$coreCopiesNotes item=field name=loop}
            {$field|escape}<br>
          {/foreach}
        </td>
      </tr>
      ...
      {if !empty($coreOriginalNotes)}
      <tr valign="top">
        <th>{translate text='Original Notes'}: </th>
        <td>
          {foreach from=$coreOriginalNotes item=field name=loop}
            {$field|escape}<br>
          {/foreach}
        </td>
      </tr>
      ...
      {if !empty($coreRepositoryCode)}
      <tr valign="top">
        <th>{translate text='Repository Code'}: </th>
        <td>{$coreRepositoryCode|escape}</td>
      </tr>
      {/if}
