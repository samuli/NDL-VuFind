<!-- START of: RecordDrivers/Index/result-browse-snippet-journal.tpl -->
<div class="grid_7">
    {include file="RecordDrivers/Index/result-onlineurls.tpl"}

  </div>
  
  <div class="grid_1 addToFavLink">
...
<!-- END of: RecordDrivers/Index/result-browse-snippet-journal.tpl -->
