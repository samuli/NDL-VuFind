...
<div class="resultCheckbox">
  ...
  <div class="resultColumn2 grid_11">
    ...
    <div class="resultItemLine1">
      <a href="{$url}/{if $summCollection}Collection{else}Record{/if}/{$summId|escape:"url"}" class="title">{$summSubtitle|escape} {if !empty($summHighlightedTitle)}{$summHighlightedTitle|addEllipsis:$summTitle|highlight}{elseif !$summTitle}{translate text='Title not available'}{else}{$summTitle|truncate:180:"..."|escape}{/if}&nbsp;{if $summYearRange}({$summYearRange|escape}){/if}</a>
    </div>
