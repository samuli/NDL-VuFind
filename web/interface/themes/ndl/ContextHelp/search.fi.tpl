   ...
   steps: [
    {
      ...
      title: 'Perushaku',
      content: '<ul><li>Kirjoita hakukenttään teoksen <em>nimi</em>, <em>tekijä</em>, <em>aihe</em> tai muita asiaan liittyviä hakusanoja.</li><li>Voit käyttää mm. hakumerkkejä <strong>?</strong>&nbsp;(mikä tahansa kirjain), <strong>*</strong>&nbsp;(useampia kirjaimia) sekä boolean-operaattoreita <strong>AND</strong>, <strong>OR</strong> ja <strong>NOT</strong>. Tarkempia esimerkkejä {/literal}<a href="{$url}/Content/searchhelp">hakuohjeessa</a>{literal}.</li><li>Tarkan fraasihaun voit tehdä kirjoittamalla hakusanat lainausmerkkeihin.</li></ul>',
      placement: 'bottom',
      arrowOffset: 60,
      padding:0
    },
