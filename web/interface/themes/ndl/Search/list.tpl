...
<div class="resultViewOptions">
    <div class="content">
      <div class="resultNumbers">
        ...
        <span class="currentPage"><span>{translate text="Search Results"}</span> {$recordStart|number_format:0:".":"&#x2006;"}&#8201;-&#8201;{$recordEnd|number_format:0:".":"&#x2006;"} / </span>
        <span class="resultTotals">{$recordCount|number_format:0:".":"&#x2006;"}</span>
