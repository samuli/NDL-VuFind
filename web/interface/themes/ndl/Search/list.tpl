  ...
  <div class="resultTerms">
    <div class="content">
      ...
      <div class="headerRight">
        <a class="button buttonFinna" href="{$searchWithFilters|escape|replace:"/Search/Results":"/Search/DualResults"|replace:"prefilter=":"prefiltered="}&dualResults=1">{translate text="All Results"}</a>
