...
<form id="inappropriateForm" action="" method="post" name="inappropriateComment">
    ...
    <label for="inapp2"><input id="inapp2" type="radio" name="reason" value="{translate text='inappropriate_reason_2'}" /> {translate text='inappropriate_reason_2'}</label><br>
    <label for="inapp3"><input id="inapp3" type="radio" name="reason" value="{translate text='inappropriate_reason_3'}" /> {translate text='inappropriate_reason_3'}</label><br>
    <label for="inapp4"><input id="inapp4" type="radio" name="reason" value="{translate text='inappropriate_reason_4'}" /> {translate text='inappropriate_reason_4'}</label><br>
    <label for="inapp5"><input id="inapp5" type="radio" name="reason" value="{translate text='inappropriate_reason_5'}" /> {translate text='inappropriate_reason_5'}</label><br>
