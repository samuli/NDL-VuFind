<!-- START of: RecordDrivers/Hierarchy/collection-info.tpl -->

<div id="collectionInfo" class="collectionInfo">
<table cellpadding="2" cellspacing="0" border="0" class="table table-condensed table-hover citation" summary="{translate text='Bibliographic Details'}">
  ...
  <tr valign="top">
    ...
    <td>
      {foreach from=$coreExtent item=field name=loop}
        {$field|escape}<br>
      {/foreach}
   </td>
  </tr>
  ...
  <tr valign="top">
    ...
    <td>
      {foreach from=$collDateDescription item=field name=loop}
        {$field|escape}<br>
      {/foreach}
   </td>
  </tr>
  ...
  {if !empty($collBiographicalHistory)}
  <tr valign="top">
    <th>{translate text='Biographical History'}: </th>
    <td>{$collDateDescription|escape}</td>
  </tr>
  {/if}
  ...
  <tr valign="top">
    ...
    <td>
      {foreach from=$collAccess item=field name=loop}
        {$field|escape}<br>
      {/foreach}
    </td>
  </tr>
  ...
  {if !empty($collRelated)}
  <tr valign="top">
    <th>{translate text='Related Material'}: </th>
    <td>
      {foreach from=$collRelated item=field name=loop}
        {$field|escape}<br>
      {/foreach}
    </td>
  </tr>
  ...
  {if !empty($collPublicationNotes)}
  <tr valign="top">
    <th>{translate text='Publication Notes'}: </th>
    <td>
      {foreach from=$collPublicationNotes item=field name=loop}
        {$field|escape}<br>
      {/foreach}
    </td>
  </tr>
  ...
  {if !empty($collActionNotes)}
  <tr valign="top">
    <th>{translate text='Action Notes'}: </th>
    <td>
      {foreach from=$collActionNotes item=field name=loop}
        {$field|escape}<br>
      {/foreach}
    </td>
  </tr>
  ...
  {if !empty($collCopiesNotes)}
  <tr valign="top">
    <th>{translate text='Copy Notes'}: </th>
    <td>
      {foreach from=$collCopiesNotes item=field name=loop}
        {$field|escape}<br>
      {/foreach}
    </td>
  </tr>
  ...
  {if !empty($collOriginalNotes)}
  <tr valign="top">
    <th>{translate text='Original Notes'}: </th>
    <td>
      {foreach from=$collOriginalNotes item=field name=loop}
        {$field|escape}<br>
      {/foreach}
    </td>
  </tr>
  ...
  {if !empty($collRepositoryCode)}
  <tr valign="top">
    <th>{translate text='Repository Code'}: </th>
    <td>{$collRepositoryCode|escape}</td>
  </tr>
  {/if}
</table>
<hr />
...
<!-- END of: RecordDrivers/Hierarchy/collection-info.tpl -->
