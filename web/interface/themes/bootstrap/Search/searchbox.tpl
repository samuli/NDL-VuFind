...
{/if}
    {if $pciEnabled}
      <li><a href="{$path}/PCI/Home" class="badge pciLink"><i class="icon-search"></i>&nbsp;{translate text="PCI Search"}</a></li>
    {/if}
    {if $metalibEnabled}
...
--> *}
      <li class=""><a href="{$path}/Browse/Home" class="badge browseLink"><i class="icon-eye-open"></i>&nbsp;{translate text="Browse the Catalog"}</a></li>
{* <!--
      <li class="btn-mini"><a href="{$path}/Content/searchhelp" class="showSearchHelp"><i class="icon-info-sign"></i>&nbsp;{translate text="Search Tips"}</a></li>
--> *}
    </ul>
