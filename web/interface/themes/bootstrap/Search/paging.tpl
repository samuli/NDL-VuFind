{if $recordCount > 0}
  <div class="pagination{if $position}{$position} hidden-phone{/if}{if !$position} pagination-centered pagination hidden-phone{/if}">
  {if !$position}
 ...
 {* Smaller paging for mobile-phones *}
  <div class="pagination{if $position}{$position} visible-phone{/if}{if !$position} pagination-centered pagination-small visible-phone{/if}">
  {if !$position}
    <div class="recordCount">
      {translate text="Search Results"}:<br />
      <strong>{$recordStart}-{$recordEnd}&nbsp;<strong>/</strong>&nbsp;{$recordCount}</strong>
