...
<div id="list2container" class="span3 browseNav">
  ...
  {foreach from=$defaultList item=area}
    <li><a href="{$url}/Browse/LCC" title="&quot;{$area.0|escape}&quot;" class="btn btn-info loadOptions query_field:callnumber-first facet_field:callnumber-subject target:list3container">{$area.0|escape} ({$area.1})</a></li>
  {/foreach}  
  </ul>
</div>
